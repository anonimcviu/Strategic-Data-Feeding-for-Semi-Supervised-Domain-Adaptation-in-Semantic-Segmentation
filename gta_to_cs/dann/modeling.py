...
from ._deeplab import DeepLabHead, DeepLabHeadV3Plus, DeepLabV3,PixelDiscriminator
...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone):
    ...
    discriminator=PixelDiscriminator(304)

    model = DeepLabV3(backbone, classifier,discriminator)
    return model
