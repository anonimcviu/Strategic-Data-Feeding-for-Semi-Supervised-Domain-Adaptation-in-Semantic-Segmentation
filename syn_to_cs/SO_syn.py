...
def get_dataset(opts):
    ...
    #transform
    cs_train = TransformDataset(cs_train, transform=train_transform)
...
def main():
    ...
    if opts.test_only:
        ...
        test_dst, batch_size=opts.val_batch_size, shuffle=False, num_workers=1,
        ...
        target_valLoader = data.DataLoader(
            val_dst_t, batch_size=opts.batch_size, shuffle=False, num_workers=2, 
            pin_memory=True,drop_last=True,worker_init_fn=worker_init_fn)
