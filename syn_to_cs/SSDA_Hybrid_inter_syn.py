...
def get_dataset(opts):
    ...
    if opts.test_only:
        ...
        return gta_train, gta_val,cs_unl,cs_val,sample_shuff,cs_lb
...
def main():
    ...
    if opts.test_only:
        ...
        source_train, source_val, target_train_unl, target_val, shuffled,target_train_lbl  = get_dataset(opts)
    ...
    with wandb.init(project="Paper_syn", name=opts.run_name):
        ...
        for e in range(opts.num_epoch):
            ...
            while cur_itrs < len_training:
                ...
                total_loss= err_s_clf + err_t_lbl_clf+err_shuf_lbl_clf  +((err_t_lbl_disc + err_t_unl_disc +err_s_disc +err_shuf_lbl_disc)/2)
                ...
                total_clf_loss += err_s_clf + err_t_lbl_clf+err_shuf_lbl_clf
                total_disc_loss +=((err_t_lbl_disc + err_t_unl_disc +err_s_disc+err_shuf_lbl_disc)/2)
