...
import shutil
import random
random.seed(17091997)

# Paths to your dataset
dataset_path = './datasets/RAND_CITYSCAPES/'
train_path = './datasets/synthia/train/'
val_path = './datasets/synthia/test/'
...
label_folder = os.path.join(dataset_path, 'GT/LABELS')

image_files =   sorted([f for f in os.listdir(image_folder) if f.endswith('.jpg') or f.endswith('.png')] ) # Adjust extensions if needed
